...
class PW_CMB2_Field_Select2 {
	...
	public function render_pw_select( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		echo $field_type_object->select( array(
			...
			'data-placeholder' => $field->args( 'attributes', 'placeholder' ) ? $field->args( 'attributes', 'placeholder' ) : $field->args( 'placeholder' ),
		) );
	}
	...
	public function setup_admin_scripts() {
		...
		wp_register_style( 'pw-select2', $asset_path . '/css/select2.min-alt.css', array(), '4.0.2' );
