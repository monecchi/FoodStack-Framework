...
add_shortcode( 'morello_toggles', 'ebor_toggles_shortcode' );
...
add_shortcode( 'morello_toggles_content', 'ebor_toggles_content_shortcode' );
...
function ebor_toggles_shortcode_vc() {
	vc_map( 
		array(
		    ...
		    'name'                    => esc_html__( 'Toggles' , 'morello' ),
		    'base'                    => 'morello_toggles',
		    'description'             => esc_html__( 'Create Accordion Content', 'morello' ),
		    'as_parent'               => array('only' => 'morello_toggles_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function ebor_toggles_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'morello-vc-block',
		    'name'            => esc_html__('Toggles Content', 'morello'),
		    'base'            => 'morello_toggles_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'morello' ),
		    "category" => esc_html__('morello WP Theme', 'morello'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'morello_toggles'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_morello_toggles extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_morello_toggles_content extends WPBakeryShortCode {}
}