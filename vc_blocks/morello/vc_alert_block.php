...
add_shortcode( 'morello_alert_block', 'ebor_alert_block_shortcode' );
...
function ebor_alert_block_shortcode_vc() {
	vc_map( 
		array(
			...
			"name" => esc_html__("Alert Bar", 'morello'),
			"base" => "morello_alert_block",
			"category" => esc_html__('morello WP Theme', 'morello'),
			'description' => 'An alert bar ideal for drawing attention.',
			"params" => array(
				array(
					"type" => "textarea_html",
					"heading" => esc_html__("Alert Content", 'morello'),
					"param_name" => "content",
					'holder' => 'div'
				),
				array(
