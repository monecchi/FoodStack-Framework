 ...
 * The Shortcode
 */
function ebor_side_icon_text_shortcode( $atts, $content = null ) {
	extract( 
		shortcode_atts( 
			array(
				'image' => '',
...
add_shortcode( 'peekskill_side_icon_text', 'ebor_side_icon_text_shortcode' );

/**
 * The VC Functions
 */
function ebor_side_icon_text_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'peekskill-vc-block',
			"name" => esc_html__("Text & Side Icon", 'peekskill'),
			"base" => "peekskill_side_icon_text",
...
add_action( 'vc_before_init', 'ebor_side_icon_text_shortcode_vc' );