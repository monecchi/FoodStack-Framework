...
add_shortcode( 'ryla_toggles', 'ebor_toggles_shortcode' );
...
add_shortcode( 'ryla_toggles_content', 'ebor_toggles_content_shortcode' );
...
function ebor_toggles_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'ryla-vc-block',
		    'name'                    => esc_html__( 'Toggles' , 'ryla' ),
		    'base'                    => 'ryla_toggles',
		    'description'             => esc_html__( 'Create Accordion Content', 'ryla' ),
		    'as_parent'               => array('only' => 'ryla_toggles_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function ebor_toggles_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'ryla-vc-block',
		    'name'            => esc_html__('Toggles Content', 'ryla'),
		    'base'            => 'ryla_toggles_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'ryla' ),
		    "category" => esc_html__('ryla WP Theme', 'ryla'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'ryla_toggles'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_ryla_toggles extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_ryla_toggles_content extends WPBakeryShortCode {}
}