...
add_shortcode( 'ryla_tabs', 'ebor_tabs_shortcode' );
...
add_shortcode( 'ryla_tabs_content', 'ebor_tabs_content_shortcode' );
...
function ebor_tabs_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'ryla-vc-block',
		    'name'                    => esc_html__( 'Tabs' , 'ryla' ),
		    'base'                    => 'ryla_tabs',
		    'description'             => esc_html__( 'Create Tabbed Content', 'ryla' ),
		    'as_parent'               => array('only' => 'ryla_tabs_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function ebor_tabs_content_shortcode_vc() {
	vc_map( 
		array(
			"icon" => 'ryla-vc-block',
		    'name'            => esc_html__('Tabs Content', 'ryla'),
		    'base'            => 'ryla_tabs_content',
		    'description'     => esc_html__( 'Tab Content Element', 'ryla' ),
		    "category" => esc_html__('ryla WP Theme', 'ryla'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'ryla_tabs'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_ryla_tabs extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_ryla_tabs_content extends WPBakeryShortCode {}
}