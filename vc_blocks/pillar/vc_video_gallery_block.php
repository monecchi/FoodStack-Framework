...
add_shortcode( 'pillar_video_gallery', 'ebor_video_gallery_shortcode' );
...
add_shortcode( 'pillar_video_gallery_content', 'ebor_video_gallery_content_shortcode' );
...
function ebor_video_gallery_shortcode_vc() {
	vc_map( 
		array(
		    ...
		    'base'                    => 'pillar_video_gallery',
		    'description'             => esc_html__( 'Create a filter gallery of lightbox images', 'pillar' ),
		    'as_parent'               => array('only' => 'pillar_video_gallery_content'), // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
...
function ebor_video_gallery_content_shortcode_vc() {
	vc_map( 
		array(
		    ...
		    'base'            => 'pillar_video_gallery_content',
		    'description'     => esc_html__( 'Toggle Content Element', 'pillar' ),
		    "category" => esc_html__('pillar WP Theme', 'pillar'),
		    'content_element' => true,
		    'as_child'        => array('only' => 'pillar_video_gallery'), // Use only|except attributes to limit parent (separate multiple values with comma)
		    'params'          => array(
		    	array(
		    		"type" => "textfield",
...
if(class_exists('WPBakeryShortCodesContainer')){
    class WPBakeryShortCode_pillar_video_gallery extends WPBakeryShortCodesContainer {}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if(class_exists('WPBakeryShortCode')){
    class WPBakeryShortCode_pillar_video_gallery_content extends WPBakeryShortCode {}
}