...
add_shortcode( 'pillar_testimonial', 'ebor_testimonial_shortcode' );
...
function ebor_testimonial_shortcode_vc() {
	vc_map( 
		array(
			...
			"name" => esc_html__("Testimonial Feeds", 'pillar'),
			"base" => "pillar_testimonial",
			...
			"params" => array(
				...
				array(
					"type" => "dropdown",
					"heading" => esc_html__("Testimonial Display Type", 'pillar'),
					"param_name" => "layout",
					"value" => array(
						'Carousel' => 'carousel',
						'Large' => 'large',
